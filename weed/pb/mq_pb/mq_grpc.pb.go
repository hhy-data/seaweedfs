...
func (c *seaweedMessagingClient) PublisherToPubBalancer(ctx context.Context, opts ...grpc.CallOption) (SeaweedMessaging_PublisherToPubBalancerClient, error) {
	stream, err := c.cc.NewStream(ctx, &SeaweedMessaging_ServiceDesc.Streams[0], "/messaging_pb.SeaweedMessaging/PublisherToPubBalancer", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *seaweedMessagingClient) BalanceTopics(ctx context.Context, in *BalanceTopicsRequest, opts ...grpc.CallOption) (*BalanceTopicsResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/messaging_pb.SeaweedMessaging/BalanceTopics", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seaweedMessagingClient) ClosePublishers(ctx context.Context, in *ClosePublishersRequest, opts ...grpc.CallOption) (*ClosePublishersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/messaging_pb.SeaweedMessaging/ClosePublishers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seaweedMessagingClient) CloseSubscribers(ctx context.Context, in *CloseSubscribersRequest, opts ...grpc.CallOption) (*CloseSubscribersResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/messaging_pb.SeaweedMessaging/CloseSubscribers", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *seaweedMessagingClient) SubscriberToSubCoordinator(ctx context.Context, opts ...grpc.CallOption) (SeaweedMessaging_SubscriberToSubCoordinatorClient, error) {
	stream, err := c.cc.NewStream(ctx, &SeaweedMessaging_ServiceDesc.Streams[1], "/messaging_pb.SeaweedMessaging/SubscriberToSubCoordinator", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *seaweedMessagingClient) PublishMessage(ctx context.Context, opts ...grpc.CallOption) (SeaweedMessaging_PublishMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &SeaweedMessaging_ServiceDesc.Streams[2], "/messaging_pb.SeaweedMessaging/PublishMessage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *seaweedMessagingClient) SubscribeMessage(ctx context.Context, opts ...grpc.CallOption) (SeaweedMessaging_SubscribeMessageClient, error) {
	stream, err := c.cc.NewStream(ctx, &SeaweedMessaging_ServiceDesc.Streams[3], "/messaging_pb.SeaweedMessaging/SubscribeMessage", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *seaweedMessagingClient) PublishFollowMe(ctx context.Context, opts ...grpc.CallOption) (SeaweedMessaging_PublishFollowMeClient, error) {
	stream, err := c.cc.NewStream(ctx, &SeaweedMessaging_ServiceDesc.Streams[4], "/messaging_pb.SeaweedMessaging/PublishFollowMe", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *seaweedMessagingClient) SubscribeFollowMe(ctx context.Context, opts ...grpc.CallOption) (SeaweedMessaging_SubscribeFollowMeClient, error) {
	stream, err := c.cc.NewStream(ctx, &SeaweedMessaging_ServiceDesc.Streams[5], "/messaging_pb.SeaweedMessaging/SubscribeFollowMe", opts...)
	if err != nil {
		return nil, err
	}
...
func _SeaweedMessaging_BalanceTopics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/messaging_pb.SeaweedMessaging/BalanceTopics",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SeaweedMessaging_ClosePublishers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/messaging_pb.SeaweedMessaging/ClosePublishers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _SeaweedMessaging_CloseSubscribers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/messaging_pb.SeaweedMessaging/CloseSubscribers",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
